...
@section('header', 'New Inventory Entry')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 italic">
        <h2 class="text-2xl font-black mb-8 underline decoration-amber-500">Product Registration</h2>
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    {{-- Stock --}}
                    <div class="form-group">
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2">Initial Stock</label>
                    ...
                    {{-- Image --}}
                    <div class="form-group">
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2">Part Image</label>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="4" required
                              class="w-full border-gray-200 rounded-lg focus:ring-[#f59e0b] focus:border-[#f59e0b] font-medium">{{ old('description') }}</textarea>
                </div>
